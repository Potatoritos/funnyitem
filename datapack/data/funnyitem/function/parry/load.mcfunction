scoreboard objectives add funnyitem_parry_cooldown dummy
scoreboard objectives add funnyitem_parry_timer dummy
...
scoreboard objectives add funnyitem_stats_parry_hit_dmg dummy "Damage parried (0.1❤)"
scoreboard objectives add funnyitem_stats_parry_deflects dummy "Arrows parried"
